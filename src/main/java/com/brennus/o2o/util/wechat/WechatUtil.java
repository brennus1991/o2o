package com.brennus.o2o.util.wechat;
...
import com.brennus.o2o.dto.UserAccessToken;
import com.brennus.o2o.dto.WechatUser;
...
public class WechatUtil {
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wxa6e90bd34a346bb4";
        log.debug("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "d426093f9c2ce1c52f94390921ef0a76";
